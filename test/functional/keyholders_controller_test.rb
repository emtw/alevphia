...
class KeyholdersControllerTest < ActionController::TestCase
  ...
  test "should create keyholder" do
    assert_difference('Keyholder.count') do
      post :create, keyholder: { first_name: @keyholder.first_name, house: @keyholder.house, keyholder: @keyholder.keyholder, last_name: @keyholder.last_name, postcode: @keyholder.postcode, user_id: @keyholder.user_id, username: @keyholder.username }
    end
  ...
  test "should update keyholder" do
    put :update, id: @keyholder, keyholder: { first_name: @keyholder.first_name, house: @keyholder.house, keyholder: @keyholder.keyholder, last_name: @keyholder.last_name, postcode: @keyholder.postcode, user_id: @keyholder.user_id, username: @keyholder.username }
    assert_redirected_to keyholder_path(assigns(:keyholder))
  end
