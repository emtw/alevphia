...
class FuneralsControllerTest < ActionController::TestCase
  ...
  test "should update funeral" do
    put :update, id: @funeral, funeral: { additional_reqs: @funeral.additional_reqs, ashes_location: @funeral.ashes_location, burial_location: @funeral.burial_location, casket_pref: @funeral.casket_pref, donations_to: @funeral.donations_to, dress_code: @funeral.dress_code, epitaph: @funeral.epitaph, final_words: @funeral.final_words, flowers: @funeral.flowers, funeral_pref: @funeral.funeral_pref, other_pref: @funeral.other_pref, readings: @funeral.readings, service_location: @funeral.service_location, songs_pref: @funeral.songs_pref, speakers: @funeral.speakers, user_id: @funeral.user_id, wake: @funeral.wake }
    assert_redirected_to funeral_path(assigns(:funeral))
  end
